# Prompt taking from:
#  Kwon, Teyun, Norman Di Palo, and Edward Johns. "Language models as zero-shot trajectory generators." IEEE Robotics and Automation Letters 9.7 (2024): 6728-6735.
...
The 3D coordinate system of the environment is as follows:
    ...
    2. The x-axis is in the depth direction, decreasing away from you.
    3. The z-axis is in the vertical direction, increasing upwards.
The robot arm end-effector is currently positioned at [INSERT EE POSITION], with the rotation value at 0, and the gripper open. The robot arm has joint limits in yaw betwen -1.6 to 3.0 in randians.
